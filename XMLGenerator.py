...
class XMLGenerator:
    ...
    def addControl(self, blindData):
        ...
        # Motor
            ...
            if(controlClutchMotor == "SG Rechargeable - [SGRM]" or controlClutchMotor == "SG Bi-Directional - [SGRM]"):
                if (torque <= 0.7):
                    resultList.append(f'\n<TEDIOptionList_Details OptionName_="-Clutch Selection" Choice_="SGRM0.7-0.7Nm Sunglow Bi Motor" ChoiceCode_="Y_CLS_SGRMB"/>')
                elif (torque <= 1.1):
        ...
        # Motor
            ...
            if(controlClutchMotor == "SG Rechargeable Motor" or controlClutchMotor == "SG Bi-Directional - [SGRM]"):
                if (torque <= 0.7):
                    ...
                    resultList.append(f'\n<TEDIOptionList_Details OptionName_="-Clutch Selection" Choice_="SGRM1.1-1.1Nm Sunglow Bi Motor" ChoiceCode_="Y_CLSSB_SGRMB2"/>')
                elif (torque <= 2):
                    resultList.append(f'\n<TEDIOptionList_Details OptionName_="-Clutch Selection" Choice_="SGRM2-2Nm Sunglow Bi Motor" ChoiceCode_="Y_CLSSB_SGRMB1"/>')
            else:
                resultList.append(f'\n<TEDIOptionList_Details OptionName_="-Clutch Selection" Choice_="{dictSBClutchMotorDesc.get(controlClutchMotor)}" ChoiceCode_="{dictSBClutchMotorCode.get(controlClutchMotor)}"/>')
    ...
    def makeOrder(self, orderArray, orderHeader):
        ...
        for order in orderArray:
            ...
            genLogger.log(f"Attempting PO: {PO} - Order Tag: {orderTag} - eMail: {email}")
